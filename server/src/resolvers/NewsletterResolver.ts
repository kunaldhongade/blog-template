        ...
        if (!payload || (payload && payload.role === "user")) {
            ...
            if (!issue) {
                ...
                if (errors.length === 0) {
                    ...
                    const link = `https://${process.env.DOMAIN}/newsletter/issue/${issue.newsletterId}`;
                        ...
                        function (error, data) {
                            if (error) {
                                ...
                                const params: aws.SES.SendEmailRequest = {
                                    ...
                                    Source: `Blog <newsletter@${process.env.DOMAIN}>`,
                                    ReplyToAddresses: [`info@${process.env.DOMAIN}`],
                                };
