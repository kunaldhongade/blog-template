                                ...
                                {(loading && !data) || error ? (
                                    ...
                                    <>
                                        ...
                                        {meData && meData.me ? (
                                            ...
                                            <PageTextMB48>
                                                In order to sign up to the newsletter, you have to log in to the blog. <Link to="/login" title="Log in to your.blog" aria-label="Log in to your.blog">Log in here</Link>
                                            </PageTextMB48>
                                        )}
                                        <SearchBoxComponent
